...
def write_log_heading(
    ...
    if filterMode == "ID":
        ...
        write_func(
            current.logFileName,
            "Characters searched in Usernames: " + ", ".join(inputtedUsernameFilter),
            logMode,
            2,
        )
        ...
        write_func(
            current.logFileName,
            "Characters searched in Comment Text: "
        ...
        write_func(
            current.logFileName,
            "Automatic Search Mode: " + str(filterSettings[1]),
            logMode,
            2,
        )
